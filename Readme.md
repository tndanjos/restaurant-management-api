...
| **Endpoint**            | **Método** | **Descrição**                                                                      | Precisa de Autenticação | **Exemplo de Requisição**                                                                                                                                                                 |
|-------------------------|------------|------------------------------------------------------------------------------------|--------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
...
| `/restaurants`          | POST       | Cria um novo restaurante no sistema.                                               | Sim                      | **URL**: `http://localhost:8080/restaurants`  <br> **Body**: `{ "name": "Restaurante do João", "cooking": "Brasileira", "address": {...}, "openingAt": "10:30", "userId": 1 }`             |
| `/restaurants/{id}`     | GET        | Obtém os detalhes de um restaurante pelo ID.                                       | Sim                      | **URL**: `http://localhost:8080/restaurants/1`                                                                                                                                             |
| `/restaurants`          | GET        | Lista todos os restaurantes com suporte a paginação.                               | Sim                      | **URL**: `http://localhost:8080/restaurants?page=0&size=10`                                                                                                                                |
| `/restaurants/{id}`     | PUT        | Atualiza os dados de um restaurante existente.                                     | Sim                      | **URL**: `http://localhost:8080/restaurants/1`  <br> **Body**: `{ "name": "Restaurante Atualizado", "cooking": "Italiana", "address": {...}, "openingAt": "11:00", "userId": 1 }`         |
| `/restaurants/{id}`     | DELETE     | Remove um restaurante pelo ID.                                                     | Sim                      | **URL**: `http://localhost:8080/restaurants/1`                                                                                                                                             |
| `/menu-items`           | POST       | Cria um novo item de menu associado a um restaurante.                              | Sim                      | **URL**: `http://localhost:8080/menu-items`  <br> **Body**: `{ "name": "Feijoada", "description": "Completa", "price": 49.90, "photoUrl": "...", "dineIn": true, "restaurantId": 1 }`     |
| `/menu-items/{id}`      | GET        | Obtém os detalhes de um item de menu pelo ID.                                      | Sim                      | **URL**: `http://localhost:8080/menu-items/1`                                                                                                                                              |
| `/menu-items`           | GET        | Lista todos os itens de menu com suporte a paginação.                              | Sim                      | **URL**: `http://localhost:8080/menu-items?page=0&size=10`                                                                                                                                |
| `/menu-items/{id}`      | PUT        | Atualiza os dados de um item de menu existente.                                    | Sim                      | **URL**: `http://localhost:8080/menu-items/1`  <br> **Body**: `{ "name": "Feijoada Premium", "description": "...", "price": 59.90, "dineIn": true, "restaurantId": 1 }`                   |
| `/menu-items/{id}`      | DELETE     | Remove um item de menu pelo ID.                                                    | Sim                      | **URL**: `http://localhost:8080/menu-items/1`                                                                                                                                              |
